...
def make_dp_matrix_needlman_wunsch(s1: str, s2: str, substitution_matrix: dict[str,dict[str,int]], gap_penalty):
...
def needlman_wunsch(s1:str, s2: str, n: int, substitution_matrix: dict, gap_penalty: int):
